			...
			<div class="col-xs-12 col-sm-8 col-md-9 col-lg-9">
				...
				<?php $values = get_the_content();
					...
					<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 clearfix small-marg-bottom">
						<div class="content">
							<span class="section-title"><span><h2>Doctoral Programs</h2></span></span>
							<?php the_content(); ?>
						</div>
					</div>
					<?php endif; ?>
				<?php endwhile; endif; ?>
					<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 clearfix">
						<div class="content">		
							<?php $query_prog = new WP_Query(array('post_type' => 'programs', 'orderby' => 'title', 'order' => 'ASC',  'degree_level' => 'doctorate', 'posts_per_page' => 1000,)); 
							$num = $query_prog->post_count; ?>
							<span class="section-title"><span><h2>Doctoral Programs by Options (<?php echo $num;?>)</h2></span></span>
