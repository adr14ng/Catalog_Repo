...
if($programs) {
	...
	{
		$depts = $depts[0];
		$department = '<a href="'.site_url().'/planning/plans/'.$depts->slug.'">'.$depts->description.'</a>';
		
		$col = get_term_by('id', $depts->parent, 'department_shortname');
		if($col)
		{
			$college = '<a href="'.site_url().'/planning/plans/'.$col->slug.'">'.$col->description.'</a>';
		}
	}
}
		...
		<div class="row">
			<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
				<div class="section-content page-title-section">
					<a class="dept-title-small" href="<?php echo site_url('/plan/'); ?>">Degree Plans</a>
					<h1 class="prog-title"><?php $aca_year.' '; the_title(); ?></h1>
				</div>
			</div>
		</div>
	</div>
		...
		<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
			<div class="row">
				<div id="breadcrumbs-wrap" class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
					<ul id="breadcrumbs">
						<li><a href="<?php echo site_url('/plan'); ?>">Degree Planning Guides</a></li>
